...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('C_dashboard/index') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= site_url('C_dashboard/list_admin'); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo site_url('C_datamustahik/index') ?>">Data Mustahik</a>
                        <a class="collapse-item" href="<?php echo site_url('C_kriteria_pekerjaan/index') ?>">Kriteria Pekerjaan</a>
                        <a class="collapse-item" href="<?php echo site_url('C_kriteria_penghasilan/index') ?>">Kriteria Penghasilann</a>
                        <a class="collapse-item" href="<?php echo site_url('C_kriteria_pengeluaran/index') ?>">Kriteria Pengeluaran</a>
                        <a class="collapse-item" href="<?php echo site_url('C_jumlahtanggungan/index') ?>">Jumlah Tanggungan</a>
                    </div>
                </div>
            </li>
