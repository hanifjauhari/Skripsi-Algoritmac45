    ...
    <div class="container-fluid">
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="<?php echo site_url('C_kriteria_penghasilan/prosestambah') ?>" method="POST">
                        <h5>Data Kriteria Penghasilan</h5>
                        <hr>
                        <div class="form-row">
                            <div class="form-group col-2">
                                <label>jumlah_penghasilan</label>
                                <input type="text" name="jumlah_penghasilan" class="form-control" required="">
